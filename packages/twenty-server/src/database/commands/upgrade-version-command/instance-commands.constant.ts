...
import { AddIsRequiredToFieldMetadataFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-9/2-9-instance-command-fast-1799200000000-add-is-required-to-field-metadata';
...
export const INSTANCE_COMMANDS = [
  ...
  AddIsRequiredToFieldMetadataFastInstanceCommand,
